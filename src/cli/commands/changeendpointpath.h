...
#ifndef CHANGEENDPOINTPATH_H
#define CHANGEENDPOINTPATH_H

#include "icommand.h"

#include <QString>

class ChangeEndpointPath : public ICommand
{    
public:
    void setEndpointPath(const QString& str);
    void exec(IPresenter* p) override;

private:
    QString path;
};

#endif // CHANGEENDPOINTPATH_H
