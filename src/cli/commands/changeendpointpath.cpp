...
#include "changeendpointpath.h"
#include "../../core/ipresenter.h"

void ChangeEndpointPath::setEndpointPath(const QString &str)
{
    path = str;
}

void ChangeEndpointPath::exec(IPresenter *p)
{
    p->endpointPathChanged(path);
}
